...
namespace SpaceCamp.Infrastructure.Security
{
    ...
    public class IsHostRequirementHandler : AuthorizationHandler<IsHostRequirement>
    {
        ...
        public IsHostRequirementHandler(SpaceCampContext context, IHttpContextAccessor contextAccessor)
        {
            _context = context;
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, IsHostRequirement requirement)
        {
            ...
            var attendee = _context.ActivityAttendees.AsNoTracking().SingleOrDefaultAsync(x => x.UserId == userId && x.ActivityId == activityId).Result;
